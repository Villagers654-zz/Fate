...
async def status_task():
    while True:
        ...
        await bot.change_presence(
            activity=discord.Game(name="4b4t.net | CPU: [{}%]".format(cpupercent))
        )
            ...
            name="4B4T - {}".format(
                random.choice(
                    [
                        ...
                        "Legit Anarchy!",
                        "TotherIsTostitos",
                        "Legit has been muted",
                        "#Free Legit",
                        "Now better than 2p2e!",
                        "6 million juice",
                        "Maps are the best",
                        "7th team lgbt",
                        "elon's musk",
                        ...
                        "YEET to DELETE",
                        "You have aids",
                        "ifyoucantbeatitYEETit",
                        "Let’s grab our paint sets",
                        "Communism",
                        "T O T H E R",
                        "FishyBear",
                        "baccacito",
                        "Why so serious?",
                        "disabled due to a exploit",
                        "mikey big gay",
                        "juice wrld",
                        "Huggably rapably fresh",
                        "♡Juice wrld♡",
                        "0/10 meme",
                        "xJuice Wrld",
                        "PURGE THE INFIDELS",
                        "Niggatry",
                        "This shit is not secure",
                        "The Security is Shit",
                        "They need the sack",
                        "Tomato juice!",
                        "Thready = bae",
                        "Send Luck Loli Hentai",
                        "Pole-Man",
                        "Disbanded",
                        "Privileged",
                        "Threadys Republic",
                        ...
                        "IM BACK!!!",
                        "u got food?",
                        "Thready = god 3xpl01ter",
                        "poleman is bae",
                        "The Fuckening",
                        "ANIMOO",
                        "MrBoom10 had the closest base to 0,0",
                        "isthismotdgood",
                        "where's the food",
                        "bettter Believe it's not butter",
                        "Lmao",
                        ...
                        "Mother of the devil",
                        "Do your homework",
                        "The base dropped harder than my grades",
                        "All the other kids",
                        "According to all known laws of aviation",
                        "Fate want sucky sucky?",
                        ...
                        "2+2 is... 10",
                        "Quest for Cake",
                        "the big lesbian is coming",
                        "Powered by Beddys ego",
                        "Art",
                        "A MAJESTIC FUCKING EAGLE",
                        "WhyAmIStillGettingHate",
                        "Fateisemo",
                        "FateisBait",
                        "Brickr Ban Book",
                        "Emo",
                        ...
                        "4b4t java fags found us",
                        "I'm back",
                        "depresso expresso",
                        "Heck=motd king",
                        "Poleman is back Mikey",
                        "ISAWEDTHISBOSTINHALF",
                        "Triiiiiipaloski",
                        "#gaslegit",
                        "This is Patrick",
                        "FD",
                        "Kill Yourself Wait Please Don't",
                        "Faggotry",
                        "Waffles",
                        "Blue Waffles",
                        "red pancakes",
                        "moooore",
                        "With a Portuguese Breakfast",
                        "The Motd King has arrived",
                        "Bow down faggots",
                        "NO U",
                        "Oh Snap",
                        "Shits going down",
...
async def message_task():
    while True:
        ...
        e.add_field(
            name="◈ Discord ◈",
            value=f"__**Owner**__: FrequencyX4\n__**Members**__: {guild.member_count}",
            inline=False,
        )
        e.add_field(
            name="◈ Memory ◈",
