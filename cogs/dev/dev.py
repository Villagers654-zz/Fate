...
#
	...
	async def configure(self, ctx, target_user: str):
		...
		# if not self.bot.responding:
		# 	return
		# if target_user == "all":
		# 	if ctx.author.id in self.bot.owner_map:
		# 		tgt = self.bot.owner_map
		# 	elif ctx.author.id in self.bot.allowed_map:
		# 		tgt = self.bot.allowed_map
		# 	else:
		# 		raise commands.CheckFailure  # WTF? Checks should not have let you here
		# 	users = tgt[ctx.author.id]
		# else:
		# 	users = [target_user]
		# conn = self.bot.active_connections[users[0]]
