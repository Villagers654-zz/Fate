...
class Sliders:
    def max(self):
        ...
        e.set_author(
            name="2B2TMCPE - Minecraft Anarchy",
            icon_url="https://cdn.discordapp.com/avatars/293420269832503306/a574a59c804e0797da44751e76cf324e.webp?size=1024",
        )
        e.set_thumbnail(
            url="https://cdn.discordapp.com/icons/630178744908382219/0a254e8cb841ba9a9d3193b5b03da4f8.webp?size=1024"
        )
        e.set_image(
            url="https://cdn.discordapp.com/icons/630178744908382219/0a254e8cb841ba9a9d3193b5b03da4f8.webp?size=1024"
        )
        e.description = (
            "This is a minecraft bedrock edition server that is based on 2b2t.org, "
    ...
    def rotten_union(self):
        ...
        e.set_author(
            name="Rotten Union",
            icon_url="https://cdn.discordapp.com/avatars/395228090013450241/f1f9803fa97805133dd18fc32e798ea1.webp?size=1024",
        )
        e.set_thumbnail(
            url="https://cdn.discordapp.com/attachments/642452511940280341/642460088312791060/662c684f2a983df4f85f.gif"
        )
        e.description = (
            "Hello, and welcome to the up and coming TF2 community servers:\n"
        ...
        e.set_image(
            url="https://cdn.discordapp.com/attachments/642452511940280341/642458545316691989/images.png"
        )
        return e
...
class Polis(commands.Cog):
    def __init__(self, bot: commands.Bot):
        ...
        self.protected = {
            "channels": [502236124308307968],
            "roles": [612384935159922699],
        }
    ...
    async def update_rules(self):
        ...
        verified = [
            ...
            if 612384935159922699 in [r.id for r in m.roles]
        ]
        e.set_author(
        ...
        e.description = (
            f"React with {emoji} to get access to the server. If you fail you'll be kicked, "
