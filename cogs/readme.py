...
class Readme(commands.Cog):
    ...
    async def _arkadia(self, ctx):
        ...
        e.description = (
            "■ **key Functions:** `Moderation, AutoMod, Utility, ReactionImages, Music`"
        )
        e.add_field(
            name="-~===🌹🥂🍸🍷Links🍷🍸🥂🌹===~-",
            value="■ [Discord Invite](http://discord.gg/ksesabz) | [Bot Invite](https://discordapp.com/oauth2/authorize?client_id=506735111543193601&permissions=1551232246&scope=bot) | [Vote](https://google.com/)",
            inline=False,
        )
        e.add_field(
            name="-~===🌹🥂🍸🍷Bio🍷🍸🥂🌹===~-",
            value="Fate is a ~~multipurpose~~ hybrid bot created for ~~sexual assault~~ fun",
        )
        e.add_field(
            name="-~===🌹🥂🍸🍷Rules🍷🍸🥂🌹===~-",
            value="■ Channel topics contain most rules\n"
            ...
            "■ Things outside of the rules can be deemed punishment worthy",
            inline=False,
        )
        e.add_field(
            name="~==🌹🥂🍸🍷Global Rules🍷🍸🥂🌹==~",
            value="■ This server abides by discords TOS, therefore breaking the TOS counts as an offense\n"
    ...
    async def _oof(self, ctx):
        ...
        e.description = (
            "■ **Bedrock:** IP: `play.2b2t.be` Port: `19132`\n"
            "■ **Java:** Address: `play.2b2t.be:19132`\n■ Full Vanilla Features\n■ Made For Bedrock\n■ Cross Platform\n■ True Anarchy"
        )
        e.add_field(
            name="-~===🌹🥂🍸🍷Links🍷🍸🥂🌹===~-",
            value="■ [Invite](http://discord.gg/azjzfvn) | [Vote](https://minecraftservers.org/server/556871) | [Store](http://2b2tbe.tebex.io/about) | [Youtube](https://youtube.be/)",
            inline=False,
        )
        e.add_field(
            name="-~===🌹🥂🍸🍷Founders🍷🍸🥂🌹===~-",
            value="Master Luke, Maxxie115, FishyBear, Ginjeet, Legit, Luck",
        )
        e.add_field(
            name="-~===🌹🥂🍸🍷Bio🍷🍸🥂🌹===~-",
            value="2B2TBE is a Cross Platform Server built upon an Anarchy Society where players can expect absolute freedom.\n"
        ...
        e.add_field(
            name="-~===🌹🥂🍸🍷Boosting🍷🍸🥂🌹===~-",
            value="■ Boost the server to give and get perks\n"
        ...
        e.add_field(
            name="-~===🌹🥂🍸🍷Misc🍷🍸🥂🌹===~-",
            value="MC VERSION [BEDROCK]: 1.9 - 1.12\nMC VERSION [JAVA]: 1.12 - 1.13\n",
            inline=False,
        )
        e.set_thumbnail(url=channel.guild.icon_url)
        await msg.edit(embed=e)
    ...
    async def _polis(self, ctx):
        ...
        e.add_field(
            name="-~===🌹🥂🍸🍷Links🍷🍸🥂🌹===~-",
            value="■ [Discord Invite](http://discord.gg/BQ23Z2E) | [Bot Invite]"
            "(https://discordapp.com/oauth2/authorize?client_id=506735111543193601&permissions=1551232246&scope=bot)",
            inline=False,
        )
        e.set_thumbnail(url=channel.guild.icon_url)
        ...
        content = content.replace(
            ":status_online:", str(self.bot.get_emoji(659976003334045727))
        )
        content = content.replace(
            ":status_idle:", str(self.bot.get_emoji(659976006030983206))
        )
        content = content.replace(
            ":status_dnd:", str(self.bot.get_emoji(659976008627388438))
        )
        content = content.replace(
            ":status_offline:", str(self.bot.get_emoji(659976011651219462))
        )
    ...
    async def _esr(self, ctx):
        ...
        msg = await self.bot.get_channel(548677537140572160).fetch_message(
            549484739162275840
        )
        ...
        e.description = (
            f"■ **[2P2E:](https://discord.gg/XGw58UZ)** play.2p2e.net : 19132\n"
        ...
        e.set_image(
            url="https://cdn.discordapp.com/attachments/501871950260469790/559193926318424084/RankCriteria.png"
        )
        e.set_footer(
            text=f"Last Updated: {datetime.now().strftime('%m-%d-%Y %I:%M%p')}"
        )
        await msg.edit(embed=e)
