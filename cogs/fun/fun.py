...
class Fun(commands.Cog):
    ...
    async def battle(self, ctx, user1: discord.User, user2: discord.User = None):
        ...
        attacks = {
            ...
            "🍨 | !target licked and swallowed his ice cream way too roughly `-5`": 5,
            "✨ | !user pulled a dream and increased his luck infinitely `∞`": 69420,
            "💩 | Villagers654 ruined the vibe causing !target to breakdown `-11`": 11,
            "🐄 | Luck's instructions were unclear leaving !target without food and shelter `-33`": 33,
            "📉 | Legit told !target to buy all the dips but !target pressed the wrong button `-5`": 5,
            ...
            "📡 | !user paid the aliens in bitcoin to abduct !target `-15`": 15,
