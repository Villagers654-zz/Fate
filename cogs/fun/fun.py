...
class Fun(commands.Cog):
    ...
    async def battle(self, ctx, user1: discord.User, user2: discord.User = None):
        ...
        attacks = {
            ...
            "🦄 | !user's unicorn sent !target off a cliff `-15`": 15,
            ...
            "🍄 | !user drugged !target with Mushroom juice `-7`": 7,
            "🍌 | !user launched bananas at !target `-9`": 9,
            ...
            "💳 | !user swiped both of !target's credit cards painfully `-15`": 15,
            "🦈 | !user morphed into sharky and swallowed !target calmly `-75`": 75,
            "🐦 | !user ratioed !target on twitter `-10`": 10,
            "🍆 | !user scared !target away with his extra large benis `-21`": 21,
            "🍩 | !target got too fat on DONUTS `-51`": 51,
            "🍨 | !target licked and swallowed his ice cream way too roughly `-25`": 25,
            "✨ | !user pulled a dream and increased his luck infinitely `∞`": 69420,
            "💩 | Villagers654 ruined the vibe causing !target to breakdown `-21`": 21,
            ...
            "🚀 | !target's rocket sent them flying into Uranus ||*did it hurt?*|| `-51`": 51,
