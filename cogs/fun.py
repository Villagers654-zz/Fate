...
class Fun(commands.Cog):
    ...
    async def personality(self, ctx, *, member: discord.Member = None):
        ...
        e.add_field(
            name="Type",
            value=f'{random.choice(["psychopath", "depressed", "cheerful", "faggotry", "bright", "dark", "god", "deceiver", "funny", "fishy", "cool", "insecure", "lonely", "optimistic", "brave", "brilliant", "dreamer", "Nurturer", "Peaceful", "Overthinker", "Idealist", "Pussy"])}',
            inline=False,
        )
        e.add_field(
            name="Social Status",
    ...
    async def gay(self, ctx, *, user: discord.Member = None):
        ...
        e.set_author(
            name=f"You are {random.randint(0,100)}% gay", icon_url=user.avatar_url
        )
        await ctx.send(embed=e)
    ...
    async def straight(self, ctx, *, user: discord.Member = None):
        ...
        e = discord.Embed(color=colors.pink())
        e.set_author(
            name=f"You are {random.randint(0,100)}% straight", icon_url=user.avatar_url
        )
        await ctx.send(embed=e)
    ...
    async def lesbian(self, ctx, *, user: discord.Member = None):
        ...
        e = discord.Embed(color=colors.pink())
        e.set_author(
            name=f"You are {random.randint(0,100)}% lesbian", icon_url=user.avatar_url
        )
        await ctx.send(embed=e)
