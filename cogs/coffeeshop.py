...
class CoffeeShop:
	...
	async def strawberriesandcream(self, ctx):
		...
		e.set_author(name=f"{ctx.author.name} kisses {self.bot.user.name}", icon_url=ctx.author.avatar_url)
		e.description = "Here's your Strawberries and Cream"
		e.set_image(url="https://cdn.discordapp.com/attachments/501871950260469790/511578465800159244/strawberriescreamfrapp.jpg")
